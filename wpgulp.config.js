...
module.exports = {
	...
	// Style options.
	styleSRC: './src/styles/styles.scss', // Path to main .scss file.
	styleDestination: './assets', // Path to place the compiled CSS file. Default set to root folder.
	...
	// JS Custom options.
	jsCustomSRC: './src/js/main.js', // Path to JS custom scripts folder.
